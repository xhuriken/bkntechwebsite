...
- Conception et implémentation du module dynamique **Portfolio** :
  ...
  - Optimisation des cartes posts de devlog de [GamingDevlog.jsx](file:///c:/Users/celestin/Desktop/bkntechwebsite/src/pages/GamingDevlog.jsx) : intégration en tête d'un mini-terminal noir complet flush (contenant le type de post ré-écrit au format `.log`, la date et le temps relatif), suppression de l'espace de commentaires inutile au bas des posts, et mise en place d'un indicateur de mise à jour sous forme de puce pulsée verte sous le titre général.
