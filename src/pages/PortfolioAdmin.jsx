                  ...
                  <AnimatePresence>
                    {statusMsg.text && (
                      <motion.div
                        ...
                        className={`p-3.5 rounded-xl border text-xs font-sans font-semibold flex items-center justify-between gap-3 shadow-md ${
                          ...
                          <div className="relative flex items-center p-1 bg-surface-container-low/50 rounded-xl border border-white/10 backdrop-blur-md select-none">
                            ...
                            <div className="flex items-center gap-1">
                              <button
                                ...
                                className={`relative z-10 w-8 h-7 flex items-center justify-center text-[10px] font-black transition-colors duration-200 cursor-pointer focus:outline-none ${
                                  textLang === 'fr' ? 'text-surface' : 'text-on-surface-variant hover:text-on-surface'
                                }`}
                              >
                                FR
                              </button>
                              <button
                                ...
                                className={`relative z-10 w-8 h-7 flex items-center justify-center text-[10px] font-black transition-colors duration-200 cursor-pointer focus:outline-none ${
                                  textLang === 'en' ? 'text-surface' : 'text-on-surface-variant hover:text-on-surface'
                                }`}
                              >
                                EN
                              </button>
